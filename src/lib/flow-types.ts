...
export const ActionTypeEnum = z.enum([
  ...
  "storage_set", // salva um valor no armazenamento persistente
  "storage_get", // recupera um valor do armazenamento persistente
...
export const ACTION_CATALOG: Record<ActionType, { title: string; description: string }> = {
  ...
  storage_set: { title: "Salvar Memória", description: "Salva uma informação para ser usada em outras execuções." },
  storage_get: { title: "Recuperar Memória", description: "Recupera uma informação salva anteriormente." },
  loop: { title: "Repetir (Loop)", description: "Executa uma série de ações para cada item de uma lista." },
