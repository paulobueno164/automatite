...
export const ActionTypeEnum = z.enum([
  ...
  "loop", // repete uma sequência de ações para cada item de uma lista
...
export const ACTION_CATALOG: Record<ActionType, { title: string; description: string }> = {
  ...
  loop: { title: "Repetir (Loop)", description: "Repete um conjunto de ações para cada item de uma lista." },
