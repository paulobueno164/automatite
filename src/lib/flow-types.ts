...
export const ActionTypeEnum = z.enum([
  ...
  "storage_set", // salva um valor no armazenamento KV
  "storage_get", // recupera um valor do armazenamento KV
...
export const ACTION_CATALOG: Record<ActionType, { title: string; description: string }> = {
  ...
  storage_set: { title: "Salvar Memória", description: "Salva uma informação para usar depois ou em outras execuções." },
  storage_get: { title: "Recuperar Memória", description: "Busca uma informação salva anteriormente pelo nome (chave)." },
