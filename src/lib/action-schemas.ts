...
export const ACTION_SCHEMAS: Record<ActionType, ActionSchema> = {
  ...
  loop: {
    fields: [
      { key: "items", label: "Lista de itens", type: "textarea", placeholder: "{itens_do_carrinho}", hint: "Variável que contém uma lista ou texto com itens separados por vírgula." },
    ],
  },
  log: {
