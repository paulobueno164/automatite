 ...
 */
/** Memoization of the encryption key to avoid redundant Buffer allocations and hex parsing. */
let cachedKey: Buffer | null = null;

/**
 * Retrieves the encryption key from environment variables or a fallback.
 * The result is cached to improve performance as this function is called frequently.
 */
