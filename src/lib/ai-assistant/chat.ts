...
12. Novas capacidades de Automação:
  ...
  - "loop": use para repetir ações para cada item de uma lista. Params: { "items": "{lista}", "actions": [...ações...] }. Dentro do loop, use {loop_item} para o valor atual e {loop_index} para a posição.
