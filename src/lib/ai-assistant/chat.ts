...
12. Novas capacidades de Automação:
  ...
  - "loop": use para repetir ações para cada item de uma lista. Params: { "items": "{lista_ou_texto}", "actions": [...sequência de ações...] }. Dentro do loop, você pode usar {loop_item} para acessar o item atual e {loop_index} para a posição.
