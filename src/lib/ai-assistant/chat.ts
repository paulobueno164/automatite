...
12. Novas capacidades de Automação:
  ...
  - "loop": use para repetir ações para cada item de uma lista. Params: { "items": "{minha_lista}", "actions": [...sub-ações...] }. Dentro das sub-ações, use {loop_item} para o item atual e {loop_index} para a posição.
