...
12. Novas capacidades de Automação:
  ...
  - "loop": use para processar uma lista de itens. Params: { "items": "{variavel_da_lista}", "actions": [...ações...] }. Cada item estará disponível em {loop_item} e o índice em {loop_index}.
