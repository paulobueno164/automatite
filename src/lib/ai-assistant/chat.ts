...
12. Novas capacidades de Automação:
  ...
  - "loop": use para repetir ações para cada item de uma lista. Params: { "items": "{minha_lista}", "actions": [...lista de ações...] }. Dentro das ações, use {loop_item} para acessar o item atual (ou {loop_item.propriedade} se for um objeto).
