...
12. Novas capacidades de Automação:
  ...
  - "loop": use para repetir ações para cada item de uma lista. Params: { "items": "{variavel_da_lista}", "actions": [...ações...] }. Dentro das ações, use {loop_item} para o valor atual e {loop_index} para a posição (0, 1, 2...).
