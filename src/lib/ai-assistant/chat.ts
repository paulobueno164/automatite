...
12. Novas capacidades de Automação:
  ...
  - "loop": use para repetir ações para cada item de uma lista. Params: { "items": "{lista_de_itens}", "actions": [...sequência de ações...] }. Use {loop_item} para acessar o item atual dentro das ações do loop.
