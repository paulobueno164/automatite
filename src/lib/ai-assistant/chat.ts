...
12. Novas capacidades de Automação:
  ...
  - "loop": use para repetir ações para cada item de uma lista. Params: { "items": "{lista}", "actions": [...ações...] }. Dentro das ações, você pode usar {loop_item} (o item atual) e {loop_index} (o índice, começando em 0). Se o item for um objeto, use {loop_item.propriedade}.
